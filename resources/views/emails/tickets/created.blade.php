...
<head>
    ...
    <style>
        ...
        .status-badge { display: inline-block; padding: 2px 10px; border-radius: 9999px; font-size: 12px; font-weight: 700; background: #fef3c7; color: #b45309; }
...
<div class="wrapper">
    <div class="header">
        ...
        <p>Se ha registrado una nueva solicitud en el sistema. Ticket <strong>#{{ $ticket->formatted_code }}</strong></p>
    </div>
    ...
    <div class="body">
        ...
        <div class="observaciones-box">{{ $ticket->description }}</div>
        @endif
